...
Note that some records could be marked with (R) in link information results. This means that communication is possible if initiated by the destination NUMA node HSA agent.
...
Note that some records could be
marked with (R) in link information results. This means that communication is possible if initiated
by the destination NUMA node HSA agent.
