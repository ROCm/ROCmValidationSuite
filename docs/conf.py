...
left_nav_title = f"ROCm RVS 1.5.118 Documentation"
...
html_theme_options = {
    "flavor": "generic",
    "header_title": f"ROCm™ RVS 1.5.118",
    "header_link": f"https://rocm.docs.amd.com/projects/ROCmValidationSuite/en/docs-1.5.118/",
    "version_list_link": f"https://rocm.docs.amd.com/projects/ROCmValidationSuite/en/docs-1.5.118/versions.html",
    "nav_secondary_items": {
