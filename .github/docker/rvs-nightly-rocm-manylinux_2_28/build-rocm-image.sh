#!/usr/bin/env bash
# Build (and tag) the ROCm runtime docker image for RVS nightly docker tests (manylinux_2_28).
...
#   ./build-rocm-image.sh --channel nightly --tag rvs-nightly-rocm-manylinux_2_28:latest

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
IMAGE_REPO="${RVS_NIGHTLY_DOCKER_IMAGE:-rvs-nightly-rocm-manylinux_2_28:latest}"
...
echo "  Base OS      : manylinux_2_28 (quay.io/pypa/manylinux_2_28_x86_64)"
