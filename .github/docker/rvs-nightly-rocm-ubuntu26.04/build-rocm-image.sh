#!/usr/bin/env bash
# Build (and tag) the ROCm runtime docker image for RVS nightly docker tests (Ubuntu 26.04).
...
IMAGE_REPO="${RVS_NIGHTLY_DOCKER_IMAGE:-rvs-nightly-rocm-ubuntu26.04:latest}"
